...
#define CONNECTION_STRING L"DRIVER={SQL Server};server=DESKTOP-SN82542\\SQLEXPRESS;database=Whatsup;Trusted_Connection=yes"
#define CONNECTUSR_STRING L"DRIVER={SQL Server};server=DESKTOP-SN82542\\SQLEXPRESS;database=Whatsup;UID=%s;PWD=%s"
