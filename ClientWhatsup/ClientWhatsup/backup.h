...
protected:
	...
	void InitializeGui()
	{
		...
		tbxUsername.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_NUMBER | ES_LEFT | ES_WINNORMALCASE, 3.73062, 0.34396, 4.18042, 0.60854, hWnd, 1002);
